...
import Announcement4 from '../English02/Announcement4';
        ...
        <Container sx={{ mt: 5, pt: 3 }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", py: 2 }}>
            <Tabs value={activeTab} onChange={handleChange} centered>
              <Tab label="Stream" value="Stream" component={Link}
                to="/english" sx={{ textTransform: "none", fontWeight: "medium" }} />
              <Tab label="Classwork" value="Classwork" component={Link}
                to="/classwork4" sx={{ textTransform: "none", fontWeight: "medium" }} />
              <Tab
                label="People"
                value="People"
                component={Link}
